...
public class ColorEntityChangeEvent extends ApplicationEvent {
	...
	public ColorEntityChangeEvent(Object source, int row, int col, MmsiEntity mmsiEntity, LocalDateTime time, char channel
			...
			, JTable currentFrame6JTableNameUpper, JTable currentFrame7JTableNameUpper) {
		super(source);
		this.row = row;
		this.col = col;
