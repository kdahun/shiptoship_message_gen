package com.nsone.generator.system.schedule;
...
import com.nsone.generator.ui.tab.ais.entity.event.quartz.AsmEntityChangeStartDateQuartz;
import com.nsone.generator.ui.tab.ais.entity.event.quartz.MmsiEntityChangeStartDate;
import com.nsone.generator.ui.tab.ais.entity.event.quartz.MmsiEntitySlotTimeChangeQuartz;
import com.nsone.generator.ui.tab.ais.entity.event.quartz.VdeEntityChangeStartDateQuartz;
	...
	public void removeStartTimeTrigger(MmsiEntity mmsiEntity) throws SchedulerException, ParseException {
		...
		if(mmsiEntity.getJob() != null) {
			...
			for (Trigger trigger : triggersOfJob) {
				boolean rtn = scheduler.unscheduleJob(trigger.getKey());
