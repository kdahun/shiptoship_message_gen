...
public class NettyTcpServerConfig {
	//
	private final TcpServerTableEntity tcpServerTableEntity;
	...
	public NettyTcpServerConfig(TcpServerTableEntity tcpServerTableEntity
		...
		//
		this.tcpServerTableEntity = tcpServerTableEntity;
	...
	public TcpServerTableEntity getTcpServerTableEntity() {
		return this.tcpServerTableEntity;
	}

	public GlobalSlotNumber getGlobalSlotNumber() {
		return this.globalSlotNumber;
	}
